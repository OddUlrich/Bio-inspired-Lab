...
optimizer = optim.SGD([{'params': model.main.parameters()}, {'params':model.fc1.parameters(), 'lr':0.01}, {'params':model.fc2.parameters(), 'lr':0.01}], lr=args.lr, momentum=args.momentum)
